<template>
  ...
  >
    <header class="modal-card-head">
      <p class="modal-card-title" v-if="albumInfo">
        <strong>{{ albumInfo.collectionCensoredName }} album</strong>
      </p>
    </header>
          ...
          <article class="media media-modal">
            ...
            <div class="media-content">
              <div class="content" v-if="albumInfo">
                ...
                <span class="has-text-grey-light" v-if="albumInfo.releaseDate"
                  >Release:
                  {{
                    albumInfo.releaseDate | moment("dddd, MMMM Do YYYY")
                  }}</span
                >
              </div>
              <div class="level is-mobile">
                <div class="level-left">
                  <a
                    class="level-item"
                    :href="albumInfo.collectionViewUrl"
                    target="_blank"
                  >
                    <b-tooltip
                      type="is-light"
                  ...
                  <a class="level-item">
                    <b-tooltip
                      type="is-light"
                      :label="
                        isInBookmark(albumInfo.collectionCensoredName)
                        ...
                        :class="[
                          {
                            favorite: isInBookmark(
                              albumInfo.collectionCensoredName
                            )
                          },
                  ...
                  <a
                    ...
                    class="level-item"
                    :href="
                      `https://www.youtube.com/results?search_query=${albumInfo.artistName} - ${albumInfo.collectionCensoredName}`
                    "
                    target="_blank"
                  >
                    <b-tooltip
            ...
            <template slot-scope="props">
              ...
              >
                <a
                  v-if="settings.youtubeLink === 'true'"
                  :href="
                    `https://www.youtube.com/results?search_query=${props.row.artistName} - ${props.row.trackName}`
                  "
                  target="_blank"
                >
                  <b-tooltip
